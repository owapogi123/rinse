    ...
    <div className="bg-[linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,1)),url('src/assets/landing-page-bg-img-2.png')] bg-cover bg-center bg-fixed flex items-center justify-center text-white w-full h-screen overflow-hidden">
      <div className="grid grid-cols-3 grid-rows-2 gap-8 w-[80%]">
        <div className="row-span-2 col-span-2 flex flex-col">
          <div className="bg-blue-100 p-12 flex-1">
            ...
            <p className="text-xl text-gray-700">
              A laundry business provides essential services that make everyday life easier for its customers. 
              By offering efficient cleaning, drying, and folding of clothes.
            </p>
          </div>
        ...
        <div className="row-span-2 p-8 bg-white flex flex-col justify-between">
          ...
          <button className="mt-8 flex items-center justify-center gap-3 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
            <svg
              className="w-6 h-6"
              fill="currentColor"
              viewBox="0 0 24 24"
