...
function ServiceCard({ title, description, discount, icon }) {
  return (
    <div className="bg-gradient-to-tr from-[#e0f2f1] to-[#a7c4c9] rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-shadow duration-300 cursor-pointer relative overflow-hidden">
      ...
      <h3 className="text-2xl font-bold text-[#24444d] mb-3 font-[Poppins] text-center">{title}</h3>
      <p className="text-[#1f2937] text-center mb-8 max-w-xs mx-auto">{description}</p>
    </div>
  );
}
  ...
  const services = [
    {
      ...
      description: 'Wash & fold laundry with eco-friendly detergents and next-day delivery.',
      icon: '🧺',
    },
    {
      title: 'Dry Cleaning',
      description: 'Professional dry cleaning service for suits, dresses, and delicates.',
      icon: '🧥',
    },
    {
      title: 'Pickup & Delivery',
      description: 'We pick up and drop off your laundry at your doorstep, hassle-free.',
      icon: '🚚',
    },
  ];
...
>
  <span className="text-xl">Back</span> 
      ...
      <p className="text-center text-gray-600 max-w-3xl mx-auto mb-16 text-lg font-[Poppins]">
        At Rinse, we offer professional laundry solutions to simplify your life. Explore our range of services below.
      </p>
