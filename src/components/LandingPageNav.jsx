    ...
    <>
      <div className="w-full sticky top-0 z-50 flex justify-start items-center bg-[#FDFBEE] p-[1rem] shadow-2xl">
        ...
        <NavLink className="ml-auto" to="/sign/up" end>
          <div className="px-[3rem] py-[0.7rem] text-[#ffffff] bg-[#24444d] rounded-lg transition-all duration-300 hover:scale-105  hover:bg-[white] active:scale-95 hover:text-[black] bg-lightblue-500 shadow-lg shadow-blue-500/50">
