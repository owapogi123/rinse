export default function LandingPageTwo() {
  return (
    <>
      <div className="w-full h-[100vh] bg-[linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,1)),url('src/assets/landing-page-bg-img.png')] bg-cover bg-center bg-fixed flex items-center justify-center text-white">
